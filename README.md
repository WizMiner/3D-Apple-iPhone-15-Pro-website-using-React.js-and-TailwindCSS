<div align="center">
  <br />
    <a href="https://github.com/WizMiner/3D-Apple-iPhone-15-Pro-website-using-React.js-and-TailwindCSS" target="_blank">
...
## <a name="tech-stack">⚙️ Developer Stack</a>
...
```bash
git clone https://github.com/WizMiner/3D-Apple-iPhone-15-Pro-website-using-React.js-and-TailwindCSS.git
cd 
```
